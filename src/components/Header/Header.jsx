...
import { Menu, X, ShoppingBag, Home, Package, Info, MessageCircle, Shield } from 'lucide-react';
        ...
        <div className="header-content">
          ...
          <div className="nav-desktop-wrapper">
            <nav className="nav-desktop">
              ...
              <Link 
                to="/admin" 
                className="nav-desktop-link admin-link"
                onMouseEnter={() => setHoveredItem('admin')}
                onMouseLeave={() => setHoveredItem(null)}
              >
                <div className="nav-icon-box admin-icon-box">
                  <Shield size={20} />
                </div>
                <span className="nav-desktop-text">Admin</span>
                <div className={`nav-underline ${hoveredItem === 'admin' ? 'active' : ''}`}></div>
              </Link>
            </nav>
          </div>
          ...
          <div className="mobile-menu-content">
            <div className="mobile-menu-items">
              ...
              <Link 
                ...
                onClick={() => setIsMenuOpen(false)}
              >
                <div className="mobile-item-icon admin-mobile-icon">
                  <Shield size={20} />
                </div>
                <span className="mobile-item-text">Admin</span>
                <div className="mobile-item-arrow">›</div>
              </Link>
