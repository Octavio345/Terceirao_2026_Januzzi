            ...
            <div className="products-action">
              ...
              <div className="retirada-info">
                ...
                <div className="retirada-text">
                  ...
                  (E.E. Prof. Oswaldo Januzzi) - Av. Frei Marcelo Manilia, 750. Horários: Intervalo das aulas e as ENTREGAS partir das 10h da manhã.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="faq-grid">
            ...
            >
              ...
              <div className="faq-answer">
                ...
                na Av. Frei Marcelo Manilia, 750 - Centro, Buritama-SP. E as entregas são feitas a partir das 10 da manhã.</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="faq-answer">
                <p><strong>Duas opções:</strong><br/>
                  ...
                  2. <strong>Entregas a partir das 10h</strong> da manhã<br/><br/>
